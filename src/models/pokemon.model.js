...
class Pokemon {
    ...
    static ajouterPokemon = (nom, type_primaire, type_secondaire, pv, attaque, defense) => {
        return new Promise((resolve, reject) => {
    ...
    static modifierPokemon = (nom, type_primaire, type_secondaire, pv, attaque, defense, id) => {
        return new Promise((resolve, reject) => {
